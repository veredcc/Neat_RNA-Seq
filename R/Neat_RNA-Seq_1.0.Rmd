...
#per contrast
allRes_contrasts = Contrasts_Enrichment_Test(term_dir, gene_lists$contrasts, Pathway2name_, Pathway2gene, 'KEGG_Enrichment_Analysis_of_Contrasts', "KEGG", pAdjustMethod=ENRICHMENT_PADJ_METHOD, pvalueCutoff=ENRICHMENT_PVAL_CUTOFF,gene2ko=FALSE,maxCategory = MAX_TERMS_IN_DOTPLOT)
