...
#specify output file
file_name = file.path (plots_dir, "Heatmap_DE_genes.png")
...
man_clusters_opt1_ordered = plot_expression_heatmap_for_precomputed_clusters (mat2plot, man_clusters_opt1, EFFECTS, GROUP, GROUP1, col_data, heatmap_file_name, plot_title = title)
...
## Prepare ranked gene lists wo filtering
...
#print table
file_name_csv = file.path (pathway_results_dir1, paste0(pathway_id1, "_GSEA_LE_genes_info.csv"))
